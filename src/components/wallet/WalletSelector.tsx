  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button className="bg-gradient-to-r from-purple-600 to-blue-500 shadow-md hover:shadow-lg hover:from-purple-700 hover:to-blue-600 transition-all">
          {connecting ? 'Connecting...' : 'Connect Wallet'}
        </Button>
      </DropdownMenuTrigger>
      <DropdownMenuContent 
        className="w-64 bg-black/90 backdrop-blur-lg text-white border-white/10 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.12)]"
        sideOffset={5}
      >
        {/* Phantom wallet */}
        {hasPhantomWallet ? (
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <div className="px-3 py-3 text-sm opacity-50 flex items-center gap-3 cursor-not-allowed m-1">
                  ...
                  <span className="text-base">Phantom (Not Installed)</span>
                </div>
              </TooltipTrigger>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <div className="px-3 py-3 text-sm opacity-50 flex items-center gap-3 cursor-not-allowed m-1">
                ...
                <span className="text-base">Solflare</span>
              </div>
            </TooltipTrigger>
            <TooltipContent className="bg-black/90 text-white border-white/10">
              <p>Coming soon</p>
