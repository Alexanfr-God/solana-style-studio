        ...
        >
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="text-center">
              <p className="text-sm font-medium text-white">Drag & drop an image here or click to browse</p>
              <p className="text-xs text-white/60 mt-1">Upload an image to automatically generate a custom wallet theme</p>
            </div>
            <Button 
