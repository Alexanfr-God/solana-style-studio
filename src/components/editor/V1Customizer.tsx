...
import AIConductorPanel from '../ai/AIConductorPanel';
...
// Enhanced V1 Editor with AI Conductor
const CreateStyleEditor = () => {
  const { uploadedImage } = useWalletCustomizationStore();

  const handleStyleGenerated = (response: any) => {
    console.log('Style generated by AI Conductor:', response);
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
      <div className="lg:col-span-1">
        <div className="flex flex-col space-y-6 md:space-y-8">
          {/* AI Conductor Panel - новый главный компонент */}
          <AIConductorPanel 
          ...
          <Card className="bg-black/30 backdrop-blur-md border-white/10">
            <CardContent className="p-4 md:p-6">
              <h2 className="text-xl font-bold mb-4 text-white">Manual Style Creation</h2>
